...
$apiKey = '917af7a54a1763c601a39f8919d35041-us13'; // Your MailChimp API Key
$listId = '8ea51dac53'; // Your MailChimp List ID
...
if( isset( $email ) AND $email != '' ) {
	...
	if ( isset( $data->status ) AND $data->status == 'subscribed' ){
		echo '{ "alert": "success", "message": "Ha sido añadido <strong>satisfactoriamente</strong> a nuestro boletín electrónico. ¡Muchas gracias!" }';
	} else {
